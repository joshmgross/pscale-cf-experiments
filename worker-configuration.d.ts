/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 92c65b738e23486be0dcc809021cee98)
// Runtime types generated with workerd@1.20250508.0 2025-05-25 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DATABASE_URL: string;
		CLOUDFLARE_HYPERDRIVE_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "CLOUDFLARE_HYPERDRIVE_ID">> {}
}
